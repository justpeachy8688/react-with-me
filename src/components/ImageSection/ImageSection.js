            ...
            <Row className="ImageSection">
                ...
                <Col className="col xs={6} md={8} about-me-text">
                    <div className="about-info">
                        ...
                        {/* </div> */}
                        {/* </div>  */}
                        <Button href="https://docs.google.com/document/d/1p5JxGWv2JVwu3oi69oTafPi6vLdkzqIcrFgS6ctT234/edit?usp=sharing" className="resume-button">Download Resume</Button>
